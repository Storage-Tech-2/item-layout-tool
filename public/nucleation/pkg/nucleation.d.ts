...
export class SchematicWrapper {
   ...
   */
  set_blocks(positions: Int32Array, block_name: string): number;
  /**
  ...
  /**
   * Add or replace a block entity at a specific position.
   * `nbt_data` should be a plain JS object.
   */
  addBlockEntity(id: string, x: number, y: number, z: number, nbt_data: any): void;
  /**
   * Place a container block and insert an item into a specific slot.
   * Useful for exporting item layouts via chest/barrel inventories.
   */
  addContainerItem(block_id: string, x: number, y: number, z: number, item_id: string, slot: number, count: number): void;
  /**
   * Add a generic entity with optional NBT object.
   */
  addEntity(id: string, x: number, y: number, z: number, nbt_data: any): void;
  /**
   * Add an item frame entity anchored to a support block position.
   * `facing` uses Minecraft directions: 0=down, 1=up, 2=north, 3=south, 4=west, 5=east.
   */
  addItemFrameEntity(item_id: string, support_x: number, support_y: number, support_z: number, facing: number, item_rotation: number, fixed: boolean): void;
  getAllEntities(): any;
...
export interface InitOutput {
  ...
  readonly schematicwrapper_get_blocks: (a: number, b: number, c: number) => any;
  ...
  readonly schematicwrapper_addBlockEntity: (a: number, b: number, c: number, d: number, e: number, f: number, g: any) => [number, number];
  readonly schematicwrapper_addContainerItem: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => [number, number];
  readonly schematicwrapper_addEntity: (a: number, b: number, c: number, d: number, e: number, f: number, g: any) => [number, number];
  readonly schematicwrapper_addItemFrameEntity: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
  readonly schematicwrapper_getAllEntities: (a: number) => any;
